...
title %t% - Compiling Assembly Files...
	...
	call asm.cmd -o tmp\head.bin arch\x86\kernel\head.asm
	call asm.cmd -f elf arch\x86\kernel\_start.asm -o tmp\_start.o
...
title %t% - Starting Virtual Machine...
	...
	taskkill /f /im virtualbox.exe>nul 2>nul
	if not exist ../qemu/vmlauncher.cmd (goto vbox)
	call ../qemu/vmlauncher.cmd
