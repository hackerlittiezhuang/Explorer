...
void init_GUI(void)
{
	...
	/**填充矩形*/
	//GUI_put_square(layer_root, 0xff0000ff, 0, 0, LAYER_ROOT_LENGTH, LAYER_ROOT_WIDTH);
	GUI_put_square(layer_root, 0xd5000000, 0, 0, LAYER_ROOT_LENGTH, LAYER_ROOT_WIDTH);
