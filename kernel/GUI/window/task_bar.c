...
void window_refresh_date(void)
{
	...
	/**重绘时钟区域*/
	GUI_put_square(taskbar_layer, 0xc0ffffff, (Video_Info.xres - 14 * 8), 1, 14 * 8, 19);			/**任务区*/
	...
	/**输出时间*/
	GUI_put_string(taskbar_layer, 0xff000000, (Video_Info.xres - 14 * 8), 4, 0, 0, font("Standard Font"), date_buf);
}
